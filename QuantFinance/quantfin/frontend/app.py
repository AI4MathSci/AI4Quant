...
def run_simulation(model_name: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    """
    try:
        logger.info(f"Sending simulation request to backend for model: {model_name} with parameters: {parameters}")
        response = requests.post(f"{BACKEND_URL}/simulate", json={"model_name": model_name, "parameters": parameters})
...
def create_gradio_interface():
    ...
    def run_model(model_name: str, initial_capital: float, strategy: str, sma_window: int, risk_tolerance: str,
        ...
        Args:
            ...
            strategy (str): The trading strategy.
            sma_window (int): The SMA window.
            risk_tolerance (str): The risk tolerance.
            asset_classes (list): The asset classes.
            risk_metric (str): The risk metric.
            confidence_level (float): The confidence level.
            holding_period (int): The holding period.
            symbol (str): The stock symbol.
            start_date (str): The start date.
            end_date (str): The end date.

        Returns:
            Dict[str, Any]: The results of the simulation or backtest.
        """
    ...
    iface = gr.Interface(
        ...
        outputs=output_text,
        title="Quantitative Finance System",
        description="Run simulations and backtests for quantitative finance models.",
        live=False
    )
    return iface
